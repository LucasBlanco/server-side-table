...
export declare const useServerSide: <T>(props: {
    ...
    serverSideProps: {
        options: Partial<{
            ...
            customFooter: (rowCount: number, page: number, rowsPerPage: number, changeRowsPerPage: (page: import("react").Key) => void, changePage: (newPage: number) => void, textLabels: Partial<import("mui-datatables").MUIDataTableTextLabels>) => import("react").ReactNode;
            ...
            customSearchRender: (searchText: string, handleSearch: (text: string) => void, hideSearch: () => void, options: any) => JSX.Element | import("react").Component<{}, {}, any>;
            ...
            onColumnSortChange: (changedColumn: string, direction: "desc" | "asc") => void;
...
export declare const useServerSidePagination: <T>(props: {
    requestFn: ServerRequestFn<T>;
    tableHandler: ReturnType<typeof serverSideHandler>;
}) => {
    data: T[];
